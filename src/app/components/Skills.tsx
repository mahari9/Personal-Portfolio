...
import { SiExpress, SiDjango, SiFlask, SiMysql, SiMongodb, SiNodedotjs, SiTypescript, SiTailwindcss, SiPostman, SiPython, SiNpm, SiYarn, SiCanva } from "react-icons/si";
import { TbBrandVscode } from "react-icons/tb";

const Skills = () => {
     return ( 
          <main className="grid gap-5 w-[100%]">
               ...
               <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                    ...
                    <div className="flex items-center justify-start sm:justify-center gap-2 sm:gap-5 shadow-sm shadow-jet rounded-lg border border-jet border-solid p-3 md:py-5 md:px-2" data-aos="fade-down">
                         <IoLogoJavascript className="text-3xl text-green-400"/>
                         <h1 className="text-litewhite text-sm md:text-lg font-bold">JavaScript</h1>
                    </div>

                    <div className="flex items-center justify-start sm:justify-center gap-2 sm:gap-5 shadow-sm shadow-jet rounded-lg border border-jet border-solid p-3 md:py-5 md:px-2" data-aos="fade-down">
                         <SiTypescript className="text-3xl text-green-400"/>
                    ...
                    <div className="flex items-center justify-start sm:justify-center gap-2 sm:gap-5 shadow-sm shadow-jet rounded-lg border border-jet border-solid p-3 md:py-5 md:px-2" data-aos="fade-down">
                         <SiPython className="text-3xl text-green-400"/>
                    ...
                    <div className="flex items-center justify-start sm:justify-center gap-2 sm:gap-5 shadow-sm shadow-jet rounded-lg border border-jet border-solid p-3 md:py-5 md:px-2" data-aos="fade-down">
                         <TbBrandNextjs className="text-3xl text-green-400"/>
                         <h1 className="text-litewhite text-sm md:text-lg font-bold">NextJS</h1>
                    </div>

                    <div className="flex items-center justify-start sm:justify-center gap-2 sm:gap-5 shadow-sm shadow-jet rounded-lg border border-jet border-solid p-3 md:py-5 md:px-2" data-aos="fade-down">
                         <SiExpress className="text-3xl text-green-400"/>
                         <h1 className="text-litewhite text-sm md:text-lg font-bold">Express</h1>
                    </div>

                    <div className="flex items-center justify-start sm:justify-center gap-2 sm:gap-5 shadow-sm shadow-jet rounded-lg border border-jet border-solid p-3 md:py-5 md:px-2" data-aos="fade-down">
                         <SiDjango className="text-3xl text-green-400"/>
                         <h1 className="text-litewhite text-sm md:text-lg font-bold">Django</h1>
                    </div>

                    <div className="flex items-center justify-start sm:justify-center gap-2 sm:gap-5 shadow-sm shadow-jet rounded-lg border border-jet border-solid p-3 md:py-5 md:px-2" data-aos="fade-down">
                         <SiFlask className="text-3xl text-green-400"/>
                         <h1 className="text-litewhite text-sm md:text-lg font-bold">Flask</h1>
                    </div>

                    <div className="flex items-center justify-start sm:justify-center gap-2 sm:gap-5 shadow-sm shadow-jet rounded-lg border border-jet border-solid p-3 md:py-5 md:px-2" data-aos="fade-down">
                         <SiMongodb className="text-3xl text-green-400"/>
                         <h1 className="text-litewhite text-sm md:text-lg font-bold">MongoDB</h1>
                    </div>

                    <div className="flex items-center justify-start sm:justify-center gap-2 sm:gap-5 shadow-sm shadow-jet rounded-lg border border-jet border-solid p-3 md:py-5 md:px-2" data-aos="fade-down">
                         <SiMysql className="text-3xl text-green-400"/>
                         <h1 className="text-litewhite text-sm md:text-lg font-bold">MYSQL</h1>
                    </div>
